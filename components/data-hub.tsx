  ...
  return (
    <section className="py-8 relative z-10" id="data-hub">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-slate-200 dark:border-slate-800 pb-3">
                      {isNewTabMode ? (
                        <button
                          ...
                          className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white/90 hover:bg-slate-100 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 text-xs font-semibold border border-slate-300 dark:border-slate-700 shadow-sm transition-all cursor-pointer shrink-0"
                        >
                        ...
                        <button
                          ...
                          className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-emerald-800 dark:text-emerald-300 text-xs font-semibold border border-slate-300 dark:border-slate-700 transition-all cursor-pointer shrink-0"
                        >
                      ...
                      <span className="text-xs text-emerald-800 dark:text-emerald-300 font-mono font-bold bg-white/90 dark:bg-emerald-950/60 px-3 py-1.5 rounded-xl border border-emerald-300 dark:border-emerald-800 shadow-sm">
                      ...
                      >
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-slate-200 dark:border-slate-800 pb-3">
                          <div className="flex items-center gap-2.5 flex-wrap">
                            ...
                            <span className="px-3 py-1 rounded-lg bg-emerald-100 dark:bg-emerald-500/20 text-emerald-800 dark:text-emerald-300 font-mono text-sm font-bold border border-emerald-200 dark:border-emerald-500/40">
                              {bulletin.headerLine}
                            </span>
                            <span className="px-2.5 py-0.5 rounded-md bg-slate-100 dark:bg-slate-800 text-slate-800 dark:text-slate-200 font-mono text-xs font-bold border border-slate-200 dark:border-slate-700 flex items-center gap-2">
                          ...
                          <div className="flex items-center gap-2 flex-wrap">
                            {isSynopticBulletin(bulletin) && (
                              <button
                                ...
                                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium bg-gradient-to-r from-emerald-600 to-teal-600 dark:from-emerald-500 dark:to-teal-600 hover:brightness-110 text-white shadow-md shadow-emerald-500/20 border border-emerald-400/30 transition-all cursor-pointer"
                              >
                            ...
                            <button
                              ...
                              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-800 dark:text-emerald-300 border border-slate-300 dark:border-emerald-500/30 transition-all cursor-pointer shrink-0"
                            >
        ...
        {decodingBulletin && (
          <div className="fixed inset-0 z-[999999] bg-slate-900/60 dark:bg-slate-950/95 backdrop-blur-md flex items-center justify-center p-2 sm:p-6 animate-in fade-in duration-200 overflow-hidden">
            <div className="glass-panel w-full h-full max-w-6xl rounded-3xl p-4 sm:p-8 border border-slate-200 dark:border-emerald-500/40 bg-white dark:bg-slate-900/98 shadow-2xl relative flex flex-col justify-between overflow-hidden space-y-4">
              
              {/* Modal Header */}
              <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-4">
                <div className="space-y-1">
                  <div className="flex items-center gap-2 flex-wrap">
                    <span className="px-2.5 py-0.5 rounded-md bg-emerald-100 dark:bg-emerald-500/20 text-emerald-800 dark:text-emerald-300 font-mono text-xs font-bold border border-emerald-200 dark:border-emerald-500/30">
                      {decodingBulletin.headerLine}
                    </span>
                    <span className="px-2.5 py-0.5 rounded-md bg-emerald-100 dark:bg-emerald-500/20 text-emerald-800 dark:text-emerald-300 text-xs font-semibold border border-emerald-200 dark:border-emerald-500/30">
                      {decodingBulletin.categoryLabel}
                    </span>
                    <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-md bg-amber-50 dark:bg-amber-500/20 text-amber-800 dark:text-amber-300 text-xs font-semibold border border-amber-200 dark:border-amber-500/30">
              ...
              {/* Decoded Table */}
              <div className="flex-1 overflow-x-auto overflow-y-auto min-h-0 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950/60 p-2 shadow-inner">
                {(() => {
              ...
              <div className="flex justify-end pt-2 border-t border-slate-200 dark:border-slate-800">
                <button
                  onClick={() => setDecodingBulletin(null)}
                  className="px-5 py-2 rounded-xl bg-emerald-600 dark:bg-emerald-600 hover:bg-emerald-700 dark:hover:bg-emerald-500 text-white text-xs font-bold shadow-md shadow-emerald-500/20 transition-all cursor-pointer"
                >
                  ปิดหน้าต่างถอดรหัส
                </button>
              </div>
        ...
        {iwxxmBulletin && (
          <div className="fixed inset-0 z-[999999] bg-slate-950/95 backdrop-blur-xl flex items-center justify-center p-2 sm:p-6 animate-in fade-in duration-200 overflow-hidden">
            <div className="glass-panel w-full h-full max-w-6xl rounded-3xl p-4 sm:p-8 border border-purple-200 dark:border-purple-500/40 bg-white dark:bg-slate-900/98 shadow-2xl relative flex flex-col justify-between overflow-hidden space-y-4">
