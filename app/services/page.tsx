...
export default async function ServicesPage({
  ...
  return (
    <main className={`min-h-screen bg-slate-50 dark:bg-[#0b132b] text-slate-900 dark:text-slate-100 flex flex-col transition-colors duration-300 ${isNewTab ? "p-4 sm:p-8 justify-center items-center" : "pt-24 sm:pt-28 lg:pt-44"}`}>
      {!isNewTab && <Navbar />}
